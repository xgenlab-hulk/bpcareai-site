...
Lipoprotein(a) is a type of lipoprotein made in the liver, structurally similar to LDL (“bad”) cholesterol—but with an added protein called apolipoprotein(a). Think of it as LDL with a sticky, clot-promoting sidekick. What makes Lp(a) unique is that its level is almost entirely determined by genetics—your genes set your baseline, and it stays remarkably steady across your lifetime.

Here’s where timing matters: estrogen has a modest lowering effect on Lp(a). During reproductive years, many women naturally have lower levels—sometimes 15–25% lower than men of the same age. But after menopause, that protective influence fades. Studies show Lp(a) levels rise slightly in the first few years post-menopause, then stabilize—but the *impact* of those levels grows with age. Why? Because Lp(a) contributes to both calcification (hardening) of arteries *and* heart valves. Over decades, even modestly elevated Lp(a) can accelerate calcium buildup on the aortic valve—leading to aortic stenosis, a condition that affects nearly 1 in 10 adults over age 75.

That’s why lipoprotein a testing women over 67 deserves attention—not as a cause for alarm, but as a thoughtful, preventive step. It’s especially meaningful if a parent or sibling developed symptomatic aortic stenosis before age 65. In those cases, your personal risk may be 2–3 times higher—and knowing your Lp(a) level helps guide monitoring and personalized care.

## How Lp(a) Is Measured—and What the Numbers Really Mean at Your Age

Lp(a) is measured through a simple, one-time blood test—no fasting required. It’s reported in either nanomoles per liter (nmol/L) or milligrams per deciliter (mg/dL). While labs vary, here’s a widely accepted interpretation:

- **Optimal**: < 30 nmol/L (< 75 mg/dL)  
- **Moderately elevated**: 30–70 nmol/L (75–175 mg/dL)  
- **High**: 70–125 nmol/L (175–300 mg/dL)  
- **Very high**: > 125 nmol/L (> 300 mg/dL)

What’s important for women over 67: reference ranges don’t change with age—but clinical context does. For example, an Lp(a) of 90 nmol/L may carry less urgency in a healthy 50-year-old, but in a 68-year-old with mild valve thickening on echo, it signals the need for closer follow-up. Also, standard lipid panels *don’t include Lp(a)*—so unless specifically ordered, it won’t appear on your report.

Another nuance: some older adults have chronic kidney disease or hypothyroidism, which can mildly elevate Lp(a). Your doctor may consider these alongside your result—but unlike LDL, Lp(a) isn’t meaningfully lowered by statins, fibrates, or thyroid hormone replacement. So the goal of testing isn’t always to “fix” the number—it’s to better understand your individual risk story.

## Who Should Prioritize Lipoprotein(a) Testing—Especially After Age 67

You don’t need to have symptoms—or even abnormal echocardiograms—to benefit from knowing your Lp(a). The strongest indicators for testing include:

- A first-degree relative (parent, sibling, child) diagnosed with **premature aortic valve stenosis**, heart attack, or stroke before age 65  
- Personal history of unexplained calcific aortic stenosis—even if mild or asymptomatic  
- Known familial hypercholesterolemia (FH) or other inherited lipid disorders  
- Persistent borderline-high calcium score (e.g., Agatston score > 100) despite normal LDL  
- Recurrent vascular events despite optimal medical therapy  

Importantly, race and ethnicity matter too. Lp(a) levels tend to be higher, on average, in Black and South Asian populations—and lower in East Asian groups. Yet guidelines often underemphasize testing in these communities. If you fall into any of these categories—or simply feel your heart health hasn’t received full attention—you have every reason to ask, “Could Lp(a) be part of my picture?”
...
Learning about lipoprotein(a) later in life isn’t about adding worry—it’s about deepening your understanding of your own body and honoring the wisdom you’ve gathered over decades. You’ve already done so much to care for your heart: choosing nourishing meals, moving your body, staying connected, showing up for yourself and others. Adding Lp(a) to your awareness simply gives you one more piece of the puzzle—helping ensure your care remains as thoughtful, personalized, and forward-looking as you are.
