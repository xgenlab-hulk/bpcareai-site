...
1. **Jaw/neck timing**: Does the discomfort begin *during* effort (e.g., digging) and fade within 2–3 minutes *after stopping*? If yes—red flag. If it appears *only after* you’ve sat down with tea? More likely musculoskeletal or GERD.  
2. **Exertion-recovery mismatch**: Do you feel unusually winded *before* your muscles tire? Or recover slower than usual—even the next day? That mismatch hints at reduced cardiac reserve.  
3. **HRV trend (via wearable)**: Many consumer devices now estimate HRV. A sustained drop >20% below your personal baseline over 2–3 gardening sessions warrants discussion with your clinician.  
4. **Symptom location**: Pain radiating to the left jaw, neck, or inner arm—not just localized soreness near a joint—is more concerning than isolated shoulder stiffness.  
5. **Response to antacids or rest**: If heartburn-like discomfort improves quickly with antacids *and* doesn’t recur with similar exertion later that week, GERD is likely. If it returns unpredictably—even with light tasks—it deserves investigation.
