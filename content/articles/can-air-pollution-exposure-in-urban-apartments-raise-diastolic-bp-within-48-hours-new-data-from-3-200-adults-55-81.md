...
- **Context matters**: BP logs paired with notes (“windows open,” “AC running,” “cooking dinner”) helped identify patterns. One participant noticed her diastolic BP crept up only on evenings she grilled on her balcony — and dropped sharply after installing a kitchen exhaust fan with outside venting.
...
1. **Adults with the APOE ε4 genotype** — present in ~25% of adults over 60 — showed stronger diastolic responses to PM2.5. This doesn’t mean you need genetic testing, but if you know you carry ε4 (e.g., from prior ancestry or health screening), treating indoor air quality as part of cardiovascular self-care becomes even more meaningful.

2. **People living on lower floors (1st–3rd) of buildings near highways or bus depots**, where PM2.5 concentrations can be 30–50% higher than upper floors — especially during morning and evening traffic surges.

3. **Those with pre-existing conditions**: mild hypertension (130–139/80–89 mm Hg), chronic kidney disease, or type 2 diabetes. Their vascular systems appear less resilient to rapid inflammatory triggers — making short-term diastolic rises both more likely and more consequential.
