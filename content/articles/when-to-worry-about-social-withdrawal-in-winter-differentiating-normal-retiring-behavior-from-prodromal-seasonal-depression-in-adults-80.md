...
1. **Pattern**: Does withdrawal coincide *only* with fall/winter and remit by March? (Seasonality supports SAD.)
2. **Pervasiveness**: Has the person stopped *all* forms of contact—even brief, low-effort ones (e.g., waving to neighbors, returning calls)?
3. **Function**: Are there concurrent changes—sleep >10 hrs/night, appetite shifts (especially carb cravings), slowed speech/movement, or new difficulty concentrating?
