...
| 维度 | 分值 | 评分标准 |
|------|------|---------|
| **长度控制** | 10分 | 130-145字符=10分, 146-150=9分, 151-155=8分 |
| **强有力开场** | 20分 | 疑问句=20分, 强动词=18分, Learn/Understand=12分 |
| **具体价值主张** | 30分 | 可数+具体结果=30分, 可数或结果=22分, 泛泛=12分 |
| **目标受众召唤** | 15分 | 精准标识=15分, 模糊=10分 |
| **行动驱动CTA** | 10分 | 紧迫性词+价值=10分, 一般=6分 |
| **语义完整性** | 8分 | Title核心概念+1个语义相关词+实体识别=8分 |
| **问答一致性** | 7分 | Title疑问→Description直接回答=7分 |

### v2.1 核心更新：新增语义完整性和问答一致性

**语义完整性评分标准** (8分):
```
8分: 包含Title核心概念 + 至少1个语义相关词 + 明确实体类型
5分: 包含Title核心概念 + 语义相关词 (缺实体)
3分: 只包含Title核心概念
0分: 缺少核心概念

示例：
Title: "Holiday Food Upsetting Your Stomach? (PPI Users Guide)"
✅ 8分: Description包含"PPIs"+"digestion"+"acid reflux"(语义相关)
✅ 5分: Description包含"stomach upset"+"meal timing"(缺实体PPI)
✅ 3分: Description只提"stomach problems"
❌ 0分: Description完全不提消化问题
```

**问答一致性评分标准** (7分):
```
7分: Title是疑问句，Description开场重复问题+给出答案+强化价值
5分: Title是疑问句，Description给出答案但未重复问题
3分: Title是疑问句，Description未直接回答
7分: Title非疑问句但有"Your"，Description呼应情境
0分: 完全不一致

示例：
Title: "Holiday Food Upsetting Your Stomach? (PPI Users Guide)"
✅ 7分: "Holiday meals upsetting your stomach? Discover why PPIs change digestion..."
✅ 5分: "Discover why PPIs change digestion after holiday meals..."
✅ 3分: "Learn about digestive health during the holidays..."
❌ 0分: "Blood pressure management is essential..."
```
...
- **v2.1新增**: Title核心概念+语义相关词必须出现
- **v2.1新增**: 如果Title是疑问句，Description必须直接回答
...
- 浪费字符（<130字符未充分利用）
- **v2.1新增**: 忽略Title核心主题
- **v2.1新增**: Title问题但Description不回答

### 高效开场模板

**开场1：疑问钩子**（最强 - v2.1推荐用于呼应Title）
```
...
```
总分 = 长度分(10) + 开场分(20) + 价值分(30) + 受众分(15) + CTA分(10) + 语义完整性分(8) + 问答一致性分(7)
...
语义完整性分计算 (v2.1新增):
- Title核心概念+语义相关词+实体: 8分
- Title核心概念+语义相关词: 5分
- 只有Title核心概念: 3分
- 缺少核心概念: 0分

问答一致性分计算 (v2.1新增):
- 疑问Title+重复问题+答案+价值: 7分
- 疑问Title+答案(未重复问题): 5分
- 疑问Title+未直接回答: 3分
- Your型Title+呼应情境: 7分
- 完全不一致: 0分
...
✅ 100分案例:
Title: "Holiday Food Upsetting Your Stomach? (PPI Users Guide)"
Description: "Holiday meals upsetting your stomach? Discover why PPIs change digestion, plus 3 tests you can do today and meal timing tricks that prevent bloating for seniors 60+."

评分:
- 长度: 148字符 (9分)
- 开场: 疑问钩子 (20分)
- 价值: "3 tests"+"prevent bloating" (30分)
- 受众: "seniors 60+" (15分)
- CTA: "today" (10分)
- 语义: PPIs+digestion+acid reflux (8分)
- 问答: 重复问题+给出答案 (7分)
总分: 99分

✅ 95分案例:
Title: "Keeping Your BP Down While Caring for Spouse with Dementia"
Description: "Caring for spouse with dementia? Get proven BP strategies for fragmented sleep and caregiver stress—plus when to adjust meds safely (ages 65-79)."

评分:
- 长度: 145字符 (10分)
- 开场: 疑问情境 (20分)
- 价值: "proven strategies"+"adjust safely" (28分)
- 受众: 情境+年龄 (15分)
- CTA: "safely" (8分)
- 语义: BP+caregiver stress+dementia (8分)
- 问答: Your型Title+呼应情境 (7分)
总分: 96分

❌ 75分案例 (v2.1标准下不合格):
Title: "Holiday Food Upsetting Your Stomach? (PPI Users Guide)"
Description: "Learn why holiday meals cause digestive issues if you take acid reflux medication. Includes simple at-home tests and gentle diet adjustments for seniors."

评分:
- 长度: 137字符 (10分)
- 开场: "Learn why"弱 (12分)
- 价值: "simple tests"不够具体 (20分)
- 受众: "seniors"太泛 (8分)
- CTA: 无 (5分)
- 语义: 提到消化+PPIs (5分) - 缺乏深度语义词
- 问答: 未重复问题 (5分)
总分: 65分 ❌
```
...
### Description检查 (v2.1 更新)
- [ ] 长度130-150字符
- [ ] 疑问句或强动词开场
- [ ] 包含可数的具体价值
- [ ] 目标受众年龄+状况
- [ ] 有紧迫性词汇
- [ ] **v2.1新增**: Title核心概念+语义相关词
- [ ] **v2.1新增**: 如果Title是疑问句，Description直接回答
...
```
title: "Holiday Food Upsetting Your Stomach? (PPI Users Guide)"
description: "Discover 5 ways to improve your digestive health during the holiday season with simple lifestyle changes."
(缺少PPI、消化机制等核心概念)
```
...
```
description: "Holiday meals upsetting your stomach? Discover why PPIs change digestion, plus 3 tests you can do today and meal timing tricks that prevent bloating for seniors 60+."
(包含PPIs、digestion、具体实体)
```

## 错误7：Title问题但Description不回答 (v2.1新增)

❌ **错误**:
```
title: "Low Blood Sugar After Meals? (50-59 Essential Guide)"
description: "Learn about blood sugar management strategies and when to consult your doctor for better health outcomes."
(未直接回答"为什么餐后低血糖")
```

✅ **正确**:
```
description: "Blood sugar crashing after meals? Discover why reactive hypoglycemia hits ages 50-59, plus 4 food timing tricks to prevent drops and when to test glucose levels today."
(直接回答问题+提供解决方案)
```
...
- description: 长度(10)+开场(20)+价值(30)+受众(15)+CTA(10)+语义(8)+问答(7) = 100
...
## v2.1 (2026-03-18) - 当前版本

**核心更新**：Description评分调整
...
- ✅ 调整Description评分维度分配：
  ...
  - **新增**：语义完整性 8分
  - **新增**：问答一致性 7分
- ✅ 新增语义完整性评分标准（Title核心概念+语义相关词+实体识别）
- ✅ 新增问答一致性评分标准（Title疑问→Description直接回答）
- ✅ 更新Description标准案例和错误示例
- ✅ 更新质量检查清单和评分计算器
...
**📌 文档路径**: `.claude/skills/MASTER-METADATA-OPTIMIZATION-STANDARD-v2.1.md`
